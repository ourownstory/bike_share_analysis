...
You can compare it with the solution on Box:  https://stanford.box.com/v/bike-data.

* Download the trip data for all years directly from the source and process it so that you can use it. 

SHORTCUT:
To save your time and nerves, you can find the pre-wrangled data on Box. 
...
```{r solution_top5_plots, warning=FALSE, out.width='100%'}
##==SOLUTION==##
